...
public class Enemy : MonoBehaviour
{
    ...
    public void TakeDamage(int damage)
    {
        ...
        // Vahingon ottamisääni random mahdollisuudella (huom. Random.Range() jälkimmäinen luku on todellisuudessa 1 pienempi)
    ...
    {
        // // 100 HP = valkoiset silmät, 50 HP = keltaiset ja 0 = punaiset
        ...
        //     Debug.Log(healthPercentage + "  väri int: " + variFloat + " lopullinen: " + variFloat * 255);
